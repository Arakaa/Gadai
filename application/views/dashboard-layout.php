...
<head>
    ...
    <script src="<?php echo base_url() ?>assets/limitless/assets/js/vendor/ui/moment/moment.min.js"></script>
    <script src="<?php echo base_url() ?>assets/limitless/assets/js/vendor/pickers/daterangepicker.js"></script>
    <script src="<?php echo base_url() ?>assets/limitless/assets/js/vendor/pickers/datepicker.min.js"></script>
    ...
    <script src="<?php echo base_url() ?>assets/limitless/assets/demo/pages/picker_date.js"></script>
    <!-- /theme JS files-->
