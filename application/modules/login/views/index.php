...
<head>
    ...
    <title>E-Gadai - Customer Login</title>
        ...
        <div class="content-wrapper">
            <div class="content-inner">
                <div class="content d-flex justify-content-center align-items-center" style="padding: 100px">
                    <!-- Login form -->
                    <?php echo form_open('/login/dologin', array('class' => 'login-form needs-validation', 'novalidate' => '')); ?>
                    ...
                    <?php echo $this->session->flashdata('CustomerLogin_ResponseMessage'); ?>
                    <div class="card mb-0">
                        ...
                        <div class="card-body">
                            ...
                            <div class="mb-3">
                                <a href="<?php echo base_url() ?>register" class="btn btn-success w-100">Register</a>
                            </div>
